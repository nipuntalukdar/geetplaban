...
func TestExecutionTree(t *testing.T) {
	...
	dispstgInfo_one := NewDispatcherStageInfo(100, "dispatcher1", "disp1")
	stageInfo_one := NewStageInfo(100, "executor1", "first")
	stageInfo_two := NewStageInfo(100, "executor2", "second")
	stageInfo_three := NewStageInfo(100, "executor3", "third")
	stageInfo_four := NewStageInfo(400, "executor4", "fourth")
